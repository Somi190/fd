...
####LOGO####
logo = """
    o__ __o          o__ __o        o          o   __o__ 
   /v     v\        /v     v\      <|\        /|>    |   
  />       <\      />       <\     / \\o    o// \   / \  
 _\o____         o/           \o   \o/ v\  /v \o/   \o/  
      \_\__o__  <|             |>   |   <\/>   |     |   
            \    \\           //   / \        / \   < >  
  \         /      \         /     \o/        \o/    |   
   o       o        o       o       |          |     o   
...
def action():
    ...
    print '[✔️] Total OK\xe2\x88\x9a Email : ' + str(len(oks)) + '/' + str(len(cpb))
    print '[✔️] CP File Has Been Saved : save/checkpoint.txt'
    print 'WHts App.03455453538'
